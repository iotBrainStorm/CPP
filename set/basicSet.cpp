...
int main() {
   ...
   * if we use lower bound function it will return the exactly same value if it is exist otherwise it will return just immediate greater value
   * if we use upper bound function it will return just immediate greater value
   */
